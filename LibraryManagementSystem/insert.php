<?php
    ...
    $_email_pattern = "/^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$/";

    $insert_query ="INSERT INTO `users`(`username`, `pass`, `email`, `mobile`) VALUES ('$r_username','$r_pass','$r_email','$r_mobile')";
    
    $duplicate_username = mysqli_query($conn,"SELECT * FROM `users` WHERE username='$r_username'");
